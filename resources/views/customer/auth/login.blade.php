<x-guest-layout>
    ...
    <div class="relative bg-gray-200 h-screen overflow-hidden">
        ...
        <div class="flex items-center justify-center h-full">
            <div class="bg-white bg-opacity-20 backdrop-blur-lg rounded-lg shadow-lg p-8 max-w-md w-full">
                ...
                <div class="mt-12">
                    <form method="POST" action="{{ route('user.login') }}" class="flex items-center">
                        ...
                        <div class="w-full relative">
                            ...
                            <x-text-input id="login" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')" required autofocus />
                            <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                            <button type="submit" class="bg-orange-600 text-gray-100 p-1.5 px-3 rounded-r-md font-semibold font-display focus:outline-none focus:shadow-outline inline shadow-lg absolute right-0 top-8">
                                <svg class="w-6 h-6 m-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="-5 -5 24 24" fill="currentColor">
                    ...
                    <div class="mt-8 text-sm font-display font-semibold text-gray-700 flex justify-center">
                        <a href="{{ route('login') }}" class="cursor-pointer text-orange-600 hover:text-orange-800 flex gap-2">
