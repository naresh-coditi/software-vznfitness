...
@section('main-section')
    <section class="w-full px-6 mt-2 flex items-center justify-center">
        <form action="{{ route(auth()->user()->roleName . 'membershipplan.update', $plan) }}" method="post"
            ...
            <div class="w-full">
                ...
                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$plan->name"
                    required autofocus />
            ...
            <div class="w-full">
                ...
                <x-text-input id="validity" class="block mt-1 w-full" type="number" name="validity" :value="$plan->validity"
                    required autofocus />
            ...
            <div class="w-full">
                ...
                <x-text-input id="cost" class="block mt-1 w-full" type="number" name="cost" :value="$plan->cost"
                    required autofocus />
...
@push('script')
    ...
    <script>
        const select = new Choices('.select2', {
            searchEnabled: false,
            searchChoices: false,
            itemSelectText: '',
            allowHTML: true,
