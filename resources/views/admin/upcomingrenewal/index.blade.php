...
<section class="w-full px-6 mt-2" x-data="notes">
    <!-- x-filters.upcoming-renewal-filter  -->
    <x-upcoming-renewal-drop-down />
            ...
            <div class="flex items-end md:items-center gap-4 flex-col md:flex-row">
                <div class="w-full mt-2">
                    <x-text-input id="search" class="block w-full" type="search" name="search"
                        value="{{ request('search') }}" placeholder="Search By  i.e Name, Email, Phone" />
                </div>
    ...
    <x-table-element>
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
            ...
            <x-table-row :class="$class">
                ...
                <x-table-data>
                    <span>
                        {{ dateFormat($plan->user->nextFollowUpDate()->next_follow_up_date ?? $plan->next_follow_up_date) }}
                        <!-- {{ $plan->user->upcomingRenewalNotes->isNotEmpty() ? dateFormat($plan->user->upcomingRenewalNotes->first()->next_follow_up_date) : 'Null' }} -->
                    </span>
                </x-table-data>
                <x-table-data>
                    ...
                    <div class="flex flex-col gap-2">
                        <span class="flex flex-col gap-3">
                            <div class="flex justify-center items-center gap-2">
                                <a href="{{ route(auth()->user()->roleName . 'upcoming.renewal.create', $plan) }}"
    ...
    <x-modal.user-notes-modal :noteType="2" />
</section>
@endsection