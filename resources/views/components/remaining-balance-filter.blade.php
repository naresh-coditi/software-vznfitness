<div>
    ...
    <div id="filterPanel" class="fixed inset-0 bg-gray-900 bg-opacity-75 hidden z-50 transition-opacity duration-300 ease-in-out">
        <div class="bg-white w-96 h-full p-6 overflow-y-auto shadow-2xl absolute right-0 top-0 transform translate-x-full transition-transform duration-300 ease-in-out animate-slide-in" id="panelContent">
            <button onclick="toggleFilterPanel()" class="text-orange-500 hover:text-orange-600 font-semibold mb-4 transition duration-200 ease-in-out">
            ...
            <form action="" method="get">
                ...
                <!-- Search input -->
                <div class="mt-4">
                    <input type="text" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-2 focus:ring-orange-500 focus:outline-none transition duration-200 ease-in-out"
                ...
                <div class="mt-4">
                    ...
                    <select id="orderby" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-2 focus:ring-orange-500 focus:outline-none transition duration-200 ease-in-out"
                        name="orderby">
                        <option value="0" {{request('orderby')=='0'?'selected':''}}>All</option>
                        <option value="1" {{request('orderby')=='1'?'selected':''}}>Name</option>
                        <option value="2" {{request('orderby')=='2'?'selected':''}}>Remaining Balance</option>
                ...
                <div class="mt-6">
                    <button type="submit" class="w-full bg-orange-500 text-white py-3 rounded-md hover:bg-orange-600 transition-all duration-300 ease-in-out transform hover:scale-105 shadow-lg">Apply Filters</button>
                </div>
            </form>
        </div>
    </div>
