@props(['country' => null, 'states' => null])
<x-modal name="leadNotes" maxWidth="5xl" :show="session('modalName') == 'leadNotes'" focusable>
            ...
            function notes() {
                return {
                    ...
                    deleteNoteModal(index, note) {
                        ...
                        url = @js(url('/'));
                        var deleteUrl = `${url}/${this.authRole}/leads/${note.id}/notes/delete`;
